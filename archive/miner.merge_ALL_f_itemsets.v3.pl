...
print OUTFILEDATAPOS "\# Version: 2.0\n";
print OUTFILEDATAPOS "\# Time: $i\n\n";
print OUTFILEDATAPOS "\# Runtime details after preparing all hashes:\n";
print OUTFILEDATAPOS "\# System time for process: $system_t\n";
print OUTFILEDATAPOS "\# User time for process: $user_t\n\n";

print OUTFILEDATANEG "\# Version: 2.0\n";
print OUTFILEDATANEG "\# Time: $i\n\n";
print OUTFILEDATANEG "\# Runtime details after preparing all hashes:\n";
print OUTFILEDATANEG "\# System time for process: $system_t\n";
print OUTFILEDATANEG "\# User time for process: $user_t\n\n";

print OUTFILEDATABOTH "\# Version: 2.0\n";
print OUTFILEDATABOTH "\# Time: $i\n\n";
print OUTFILEDATABOTH "\# Runtime details after preparing all hashes:\n";
print OUTFILEDATABOTH "\# System time for process: $system_t\n";
print OUTFILEDATABOTH "\# User time for process: $user_t\n\n";

print OUTFILESTATS "\# Version: 2.0\n";
...
print OUTFILESTATS "STATISTICS FOR + STRAND\n\n";
...
if ($count_plus_u1 > 0){
	...
	print OUTFILESTATS "Average confidence :\t".&round2($conf_plus_u1/$count_plus_u1)."\n";
}
...
if ($count_plus_u2 > 0){
	...
	print OUTFILESTATS "Average confidence :\t".&round2($conf_plus_u2/$count_plus_u2)."\n";
}
...
if ($count_plus_u3 > 0){
	...
	print OUTFILESTATS "Average confidence :\t",&round2($conf_plus_u3/$count_plus_u3)."\n";
}
...
if ($count_plus_u4 > 0){
	...
	print OUTFILESTATS "Average confidence :\t".&round2($conf_plus_u4/$count_plus_u4)."\n";
}
...
if ($count_plus_u5 > 0){
	...
	print OUTFILESTATS "Average confidence :\t".&round2($conf_plus_u5/$count_plus_u5)."\n";
}
...
if ($count_plus_d1 > 0){
	...
	print OUTFILESTATS "Average confidence :\t".&round2($conf_plus_d1/$count_plus_d1)."\n";
}
...
if ($count_plus_d2 > 0){
	...
	print OUTFILESTATS "Average confidence :\t".&round2($conf_plus_d2/$count_plus_d2)."\n";
}
...
if ($count_plus_d3 > 0){
	...
	print OUTFILESTATS "Average confidence :\t".&round2($conf_plus_d3/$count_plus_d3)."\n";
}
...
if ($count_plus_d4 > 0){
	...
	print OUTFILESTATS "Average confidence :\t".&round2($conf_plus_d4/$count_plus_d4)."\n";
}
...
if ($count_plus_d5 > 0){
	...
	print OUTFILESTATS "Average confidence :\t".&round2($conf_plus_d5/$count_plus_d5)."\n";
}
...
if ($count_plus_IN > 0){
	...
	print OUTFILESTATS "Average confidence :\t".&round2($conf_plus_IN/$count_plus_IN)."\n";
}
...
if ($count_plus_Ov1030 > 0){
	...
	print OUTFILESTATS "Average confidence :\t".&round2($conf_plus_Ov1030/$count_plus_Ov1030)."\n";
}
...
if ($count_plus_Ov3070 > 0){
	...
	print OUTFILESTATS "Average confidence :\t".&round2($conf_plus_Ov3070/$count_plus_Ov3070)."\n";
}
...
if ($count_plus_Ov70plus > 0){
	...
	print OUTFILESTATS "Average confidence :\t".&round2($conf_plus_Ov70plus/$count_plus_Ov70plus)."\n";
}
...
if ($count_comp_Ov1030 > 0){
	...
	print OUTFILESTATS "Average confidence :\t".&round2($conf_comp_Ov1030/$count_comp_Ov1030)."\n";
}
print OUTFILESTATS "Relationship type: Overlap (30 to 70%)\n";
...
if ($count_comp_Ov3070 > 0){
	...
	print OUTFILESTATS "Average confidence :\t".&round2($conf_comp_Ov3070/$count_comp_Ov3070)."\n";
}
print OUTFILESTATS "Relationship type: Overlap (70% or more)\n";
...
if ($count_comp_Ov70plus > 0){
	...
	print OUTFILESTATS "Average confidence :\t".&round2($conf_comp_Ov70plus/$count_comp_Ov70plus)."\n";
}
...
if ($count_both_Ov1030 > 0){
	...
	print OUTFILESTATS "Average confidence :\t".&round2($conf_both_Ov1030/$count_both_Ov1030)."\n";
}
print OUTFILESTATS "Relationship type: Overlap (30 to 70%)\n";
...
if ($count_both_Ov70plus > 0){
	...
	print OUTFILESTATS "Average confidence :\t".&round2($conf_both_Ov3070/$count_both_Ov3070)."\n";
}
print OUTFILESTATS "Relationship type: Overlap (70% or more)\n";
...
if ($count_both_Ov70plus > 0){
	...
	print OUTFILESTATS "Average confidence :\t".&round2($conf_both_Ov70plus/$count_both_Ov70plus)."\n";
}
