...
# 			if (!exists $ref_relations[$l][0]){ print "rrel 0 missing!\n";}
		...
		if ($count_u1 > 0){
			$itemsets[$ctr][0]=$ref_fam;
			$itemsets[$ctr][1]=&get_count($ref_fam);
			$itemsets[$ctr][2]=&get_avglen($ref_fam);
			$itemsets[$ctr][3]=$sub_fam;
			$itemsets[$ctr][4]=&get_count($sub_fam);
			$itemsets[$ctr][5]=&get_avglen($sub_fam);
...
#calculating time taken
($user_t,$system_t,$cuser_t,$csystem_t) = times;
print OUTFILEDATA "\# Runtime details after printing the itemsets: \n";
print OUTFILEDATA "\# System time for process: $system_t\n";
#print OUTFILEDATA "\# System time for children: $csystem_t\n";
print OUTFILEDATA "\# User time for process: $user_t\n";
#print OUTFILEDATA "\# User time for children: $cuser_t\n";
...
print "\# Runtime details after printing the pruned itemsets: \n";
