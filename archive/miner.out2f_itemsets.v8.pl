...
my  ($ifname,$rec,@temp,%temphash,$ctr,$i,$j);

my (@table,@famnames,@counts,$ups_ctr,$dns_ctr,
$ref_img,$ref_fam,$ref_start,$ref_end,$ref_strand,
$sub_fam,$sub_img,$sub_start,$sub_end,$sub_strand,
%pos_relationships, %comp_relationships, %both_relationships, 
%pos_rel_history, %comp_rel_history, %both_rel_history,
