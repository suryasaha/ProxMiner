...
print OUTFILEDATA "\# Version: 10.0\n";
print OUTFILECOPIESPOS "\# Version: 10.0\n";
print OUTFILECOPIESCOMP "\# Version: 10.0\n";
print OUTFILECOPIESBOTH "\# Version: 10.0\n";
$i=localtime();
...
#### #### #### #### #### #### Continue fixing from here. Chk _copy_ctr's #### #### #### #### #### #### #### #### 
