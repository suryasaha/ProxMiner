...
#print data to file
print OUTFILEDATA "\#Output sorted on strand, difference conf, difference\n\n";

print OUTFILEDATA "\#fam1, Category, fam2, Occ, Occ conf, Avg Rand Coin, Avg Rand Coin conf, Diff, Diff conf, Strand, fam1, fam1-count, fam1-avglen, fam2, fam2-count, fam2-avglen\n";
foreach $i (@merged_table){
	print OUTFILEDATA "$i->[0]\t$i->[13]\t$i->[3]\t$i->[6]\t$i->[7]\t$i->[8]\t$i->[9]\t";
	print OUTFILEDATA "$i->[10]\t$i->[11]\t$i->[12]\t$i->[0]\t$i->[1]\t$i->[2]\t$i->[3]\t";
	print OUTFILEDATA "$i->[4]\t$i->[5]\n";
}
